...
public class Launcher {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            PrimaryServer server1 = new PrimaryServer(1, SERVER1_PORT, HOST, monitor.getPort());
            ...
            BackupServer server2 = new BackupServer(2, SERVER2_PORT, HOST, monitor.getPort());
            ...
            BackupServer server3 = new BackupServer(3, SERVER3_PORT, HOST, monitor.getPort());
            ...
            System.out.println("[MAIN] Monitor: " + HOST + ":" + monitor.getPort());
            ...
            javax.swing.SwingUtilities.invokeLater(() -> {
                AdminInterface admin = new AdminInterface(HOST, monitor.getPort());
            ...
            while (running) {
                ...
                switch (cmd) {
                    ...
                    case "status":
                        ...
                        checkPort("Monitor",  monitor.getPort());
                        break;
